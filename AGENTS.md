...
Six scorers ship (see `benchmark_suite/scoring/`):
...
├── workloads/             # sauce chat/session catalogs + token padding tests
...
- 337 tests passing (kind=sauce house-blend mixed workload + TTFT/TPOT/prefill/decode/KV tracking)
